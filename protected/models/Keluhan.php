...
class Keluhan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('kodeBarang, lokasiBarang, berita', 'required', 'message' => Yii::t('keluhan', '{attribute} kaga boleh sampe kosong.', array())),
			array('kodeBarang', 'numerical', 'integerOnly'=>true, 'message' => Yii::t('keluhan', '{attribute} cuma boleh angka.', array())),
			array('lokasiBarang', 'length', 'max'=>20, 'message' => Yii::t('keluhan', '{attribute} jangan lebih dari 20 karakter.', array())),
