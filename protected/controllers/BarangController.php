...
class BarangController extends Controller
{
	 ...
	 */
	 ...
	 public function actionfunctionLogo()
    {
        if($_POST['controllerBarang']['logo']=="ON")
        {      
           //For only text field
           ...
           echo $form->dropDownList($model,'logo',
	...
	//function Warna
	public function actionfunctionWarna()
    {
        if($_POST['controllerBarang']['warna']=="ON")
        {      
           //For only text field
           //echo CHtml::textField("Employment",'applying_position'); 
           ...
           echo $form->dropDownList($model,'warna',
